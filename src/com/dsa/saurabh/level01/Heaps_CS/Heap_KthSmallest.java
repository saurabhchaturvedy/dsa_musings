...
public class Heap_KthSmallest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Heap_KthSmallest.kthSmallestElementInGivenArrayMaxHeap(arr, k));
        System.out.println(Heap_KthSmallest.kthSmallestElementInGivenArrayMinHeap(arr, k));
