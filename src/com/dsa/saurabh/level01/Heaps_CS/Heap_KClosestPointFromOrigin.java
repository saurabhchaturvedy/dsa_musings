...
public class Heap_KClosestPointFromOrigin {
    ...
    public static void main(String[] args) {
        ...
        List<Coordinate> kClosestPointsUsingList = Heap_KClosestPointFromOrigin.kClosestPointFromOriginUsingList(listOfCoordinate, 2);
        ...
        List<Coordinate> kClosestPointsUsingMinHeap = Heap_KClosestPointFromOrigin.kClosestPointFromOriginUsingMinHeap(listOfCoordinate, 2);
        ...
        List<Coordinate> kClosestPointsUsingMaxHeap = Heap_KClosestPointFromOrigin.kClosestPointFromOriginUsingMaxHeap(listOfCoordinate, 2);
